  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [..._buildBalanceView(), _buildAddBalanceButton()],
      ),
    );
  }
  ...
  Widget _buildAddBalanceButton() {
    return Column(
      children: [
        ElevatedButton(
            onPressed: () {
              context.goNamed(AppRoutes.adjustBalance);
            },
      ...
      Row(
        ...
        children: [
          ...
          Text(
            "Cash",
            style: TextStyle(
                fontFamily: "Bassa", fontWeight: FontWeight.w500, fontSize: 15),
          ),
        ],
      ),
      Text(
